...
/**
 * Migración baseline — AquaWash
 *
 * Schema completo y correcto desde cero.
 * - Auth fields (email_verified, tokens) viven en USUARIOS, no en lavaderos.
 * - lavaderos solo tiene datos del negocio + horarios.
 * - refresh_tokens apunta a usuario_id (no a lavadero_id).
 *
 * Para usar este archivo:
 *   1. Borrar las dos migraciones anteriores de src/migrations/
 *   2. Colocar este archivo como único archivo en src/migrations/
...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        await queryInterface.createTable('lavaderos', {
            ...
            // Días abiertos (1 = abre, 0 = cerrado)
        ...
        // ─── 2. USUARIOS ───────────────────────────────────────────────────
        // Todos los campos de autenticación viven aquí, NO en lavaderos.
        ...
        // ─── 6. REFRESH TOKENS ─────────────────────────────────────────────
        // Apunta a usuarios.id (no a lavaderos.id)
    ...
    async down(queryInterface) {
        ...
        // Eliminar ENUMs que Postgres crea como tipos separados
