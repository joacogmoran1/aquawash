                        ...
                        <div className={shared.sectionHeader}>
                            ...
                            <div className={shared.sectionHeaderRight}>
                                <div className={shared.totalText}>
                                    Total: <span className={shared.totalValue}>${totalSemana.toLocaleString("es-AR")}</span>
                                </div>
                                ...
                                {semanaActual.map((d) => (
                                    <div className={styles.barCol} key={d.day}>
                                        ...
                                        <div
                                            ...
                                            style={{ height: `${(d.ingresos / maxIngresos) * 90}px` }}
                                        />
                ...
                <div className={styles.rightColumn}>
                    <SectionCard>
                        ...
                        {[
                            ...
                            const tot =
                                Object.values(stats?.ordenes_activas || {}).reduce((a, b) => a + b, 0) || 1;

                            return (
                                <div key={s.nombre} className={styles.serviceItem}>
                                    <div className={styles.serviceRow}>
                                        <span className={styles.serviceName}>{s.nombre}</span>
                                        <span className={styles.serviceCount} style={{ color: s.color }}>
                                            {n}
                                        </span>
                                    </div>
                                    <div className={styles.progressTrack}>
                                        <div
                                            ...
                                            style={{ width: `${Math.round((n / tot) * 100)}%`, background: s.color }}
                                        />
                                    </div>
                                </div>
                            );
                    ...
                    <SectionCard>
                        <div className={`${shared.sectionTitle} ${styles.sideSectionTitle}`}>Métricas</div>
                        ...
                        {[
                            ...
                            <div key={r.label} className={styles.summaryRow}>
                                ...
                                <span className={styles.summaryValue} style={{ color: r.color }}>
                                    {r.value}
                                </span>
                            </div>
                        ))}
