...
export function SecurityCard({
    email, emailVerified,
    resendingVerification, sendingPasswordReset,
    onSendPasswordReset, onDeleteAccount, deletingAccount,
}) {
    ...
    return (
        <>
                ...
                <div className={styles.stack}>
                    ...
                    <div className={styles.infoBox}>
                        ...
                        <div className={styles.infoText}>
                            Te enviaremos un enlace seguro a <strong>{email || 'tu email'}</strong> para
                            que puedas definir una nueva contraseña.
                        </div>
                        <button
                    ...
                    <div className={styles.dangerBox}>
                        ...
                        <div className={styles.infoText}>
                            Eliminar la cuenta borra permanentemente todos los datos: clientes, autos,
                            servicios, turnos e historial.{' '}
            ...
            >
                <div className={styles.dangerTitle} style={{ marginBottom: 8 }}>Eliminar cuenta</div>
                <p className={styles.infoText}>
                    Esta acción es <strong>irreversible</strong>. Se eliminarán todos los datos de tu
                    lavadero. Ingresá tu contraseña para confirmar.
                </p>
