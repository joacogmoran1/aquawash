...
// Utils
import { estadoBadge } from "../../../utils/calendarHelpers.jsx";
            ...
            <div className={styles.sectionHeaderCompact}>
                <div>
                    ...
                    <div className={styles.selectedDateMeta}>
                        {loading
                            ? "Cargando…"
                            : `${selTurnos.length} TURNO${selTurnos.length !== 1 ? "S" : ""}`}
                    </div>
                </div>
            ...
            <div className={styles.appointmentsBody}>
                {selTurnos.length === 0 ? (
                    <div className={styles.emptyState}>
                        ...
                        <div className={styles.emptyText}>Sin turnos para este día</div>
                    </div>
                ) : (
                                ...
                                <div className={styles.apptCardHeader}>
                                    <div>
                                        ...
                                        <div className={styles.apptCar}>
                                            {t.Auto
                                                ? `${t.Auto.marca} ${t.Auto.modelo} · ${t.Auto.patente}`
                                                : "—"}
                                        </div>
